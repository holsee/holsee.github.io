...
> Also note, I am making some assumptions based on what I _know_ and rolling on gut in many areas - many micro-optmisations to be found and the fun is in the details.  Also, I need to setup a proper test bench so the numbers in this post are more relative than maxed out. But compared to the existing alternatives, this ring buffer goes brrr.
